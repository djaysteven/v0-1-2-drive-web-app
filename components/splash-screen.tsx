    ...
    <>
      ...
      <style jsx>{`
        ...
        @keyframes smokeTrail1 {
          ...
          100% {
            transform: translateX(-45px) translateY(35px) scale(0.25);
            opacity: 0;
          }
        }
        ...
        @keyframes smokeTrail2 {
          ...
          100% {
            transform: translateX(-60px) translateY(10px) scale(0.35);
            opacity: 0;
          }
        }
        ...
        @keyframes smokeTrail3 {
          ...
          100% {
            transform: translateX(-55px) translateY(-40px) scale(0.28);
            opacity: 0;
          }
        }
        ...
        @keyframes smokeTrail4 {
          ...
          100% {
            transform: translateX(-40px) translateY(25px) scale(0.32);
            opacity: 0;
          }
        }
        ...
        @keyframes smokeTrail5 {
          ...
          100% {
            transform: translateX(-65px) translateY(-15px) scale(0.26);
            opacity: 0;
          }
        }
      `}</style>
